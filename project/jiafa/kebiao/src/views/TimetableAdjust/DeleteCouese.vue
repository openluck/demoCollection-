 ...
 * @LastEditors: cb
 * @LastEditTime: 2021-10-12 15:31:45
-->
<template>
  <div class="cb-container">
     ...
     <div v-show="!skeletonLoading"  class="cb-p-filter">
       <div>
         <FilterDelCouese ref="FilterDelCouese"  @filterTimetable='filterTimetable'/>
       </div>
       <div class="cb-p-btn">
        ...
        <a-button style="background:#f28955;border-color:#f28955" @click="adjustment($event)" type="primary">
          <svg-icon icon-class="com_close" :scale="0.8" style="margin-right:8px;color:#fff"></svg-icon>
          删除课程
        </a-button>
     ...
     <div  v-show="!skeletonLoading" class="cb-p-tb">
        <!-- 时间 -->
        <a-week-picker
          id="selectWeek"
          :allowClear="false"
     ...
     <!-- 课表 -->
     <div  v-show="!skeletonLoading" class="cb-p-list">
     ...
     <DeleteCoueseModal @partObj='partObj' ref="DeleteCoueseModal"/>
