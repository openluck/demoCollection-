 ...
 * @LastEditors: went
 * @LastEditTime: 2021-10-19 11:50:39
-->
    ...
    initConfirm() {
      this.$refs.initModalForm.validate(valid => {
        if (valid) {
          ...
          this.setReLesInitSecId(this.initModalForm.secId);
          this.setReLesInitSubjectId(this.initModalForm.subjectId);
          this.setReLesInitTeacherId(this.initModalForm.teacherId);
