...
//   return request('perArrange/setPermissio n', params)
// }
// 获取权限对应角色列表
export const getPermissionList = params => {
  return request('userSet/getPermissionList', params)
}
//获取人员安排列表数据
export const getArrangeList = params => {
  return request('userSet/getUserRangeList', params)
}
//删除人员
export const delectUser = params => {
  return request('userSet/delectUsers', params)
}


//获取人员列表(添加人员)
export const getUserList = params => {
  return request('userSet/getUserLists', params)
}
//添加人员
export const addUser = params => {
  return request('userSet/addUsers', params)
}


//获取权限场所树
export const getSchoolList = params => {
  return request('userSet/getSchoolList', params)
}
// 获取场所树下场所列表
export const getPlaceList = params => {
  return request('userSet/getPlaceLists', params)
}
// 设置范围
export const setRange = params => {
  return request('userSet/setRanges', params)
}
