 ...
 * @Last Modified by: tj
 * @Last Modified time: 2021-01-20 16:50:14
 * 教学质量-课程统计-学院统计页面
 */
...
class ZoeQuaClaCollege extends Component {
  constructor(props) {
    super(props);
    this.state = {
      collegeId: '', //开课单位id
  ...
  render() {
    ...
    const { QuaClaColSta, collegeId, courseId, pinkInfo, isLoading, pageNum, pageSize, curSign, subPageType } = this.props;
    const orderTh = [
      {
          title: "开课单位",
    ...
    return (
      <div style={{ height: "calc(100% - 45px)" }}>
        <ZoeQuaStatis subPageType={1} curSign={1} />
...
export default ZoeQuaClaCollege;