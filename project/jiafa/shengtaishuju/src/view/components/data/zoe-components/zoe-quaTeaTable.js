 ...
 * @Last Modified time: 2020-03-17 11:01:30
 * 暂时使用 2021/07/20
 */
...
class ZoeQuaTeaTable extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
    ...
    render() {
        const { QuaMasColSta, QuaMasTeaSta, QuaMasAdmSta, QuaMasRoomSta, curSign,isLoading,pageNum,pageSize } = this.props
        const orderTh = [
            {
                title: "开课单位",
        ...
        return (
            ...
            >
                <Table
                    ...
                    loading={isLoading}
                    className={curSign!==4?"zoe-qua-tea-table zoe-order-table-click":"zoe-qua-tea-table zoe-order-table-noclick"}
                    columns={orderTh}
                    dataSource={curSign === 1 ? QuaMasColSta.list : curSign === 2 ? QuaMasTeaSta.list :
                        curSign === 3 ? QuaMasAdmSta.list : curSign === 4 ? QuaMasRoomSta.list :
                            []}
                    pagination={false}
                ...
                />
                {
                    curSign !== 1 ?
                        <Fy
                            total={curSign===2?QuaMasTeaSta.total:curSign===3?QuaMasAdmSta.total:curSign===4?QuaMasRoomSta.total:0}
                            pageIndex={pageNum}
                            pageSize={pageSize}
