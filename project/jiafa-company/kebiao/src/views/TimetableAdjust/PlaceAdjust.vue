 ...
 * @LastEditors: cb
 * @LastEditTime: 2021-10-11 15:56:19
-->
<template>
  <div class="cb-container">
     ...
     <div class="cb-p-filter">
       ...
       <div class="cb-p-btn">
        ...
        <a-button @click="adjustment" type="primary">
     ...
     <!-- 课表 -->
     <div class="cb-p-list" v-show="!skeletonLoading">
     ...
     <PlaceModal ref="PlaceModal" @partObj='partObj'/>
     <RecordModal ref="RecordModal" />
     <OperatePlace ref="OperatePlace" @init="init" />
...
export default {
  ...
  methods: {
    ...
    async getplaceCourseList() {
      const res = await this.$api.placeAdjust.getplaceCourseList({ 'placeId': this.searchData.placeId });
      if (res.code === '200' && res.result) {
