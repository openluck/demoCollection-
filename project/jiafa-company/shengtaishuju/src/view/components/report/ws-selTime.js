 ...
 * @Last Modified by: hf
 * @Last Modified time: 2021-03-24 16:29:24
 * 选择时间组件
 */
...
class SelReportTime extends Component {
    constructor(props) {
        super(props);
        this.state = {
            timeType: "",//选择的类型
    ...
    componentDidMount() {
        ...
        this.setState({
            selSemeter: selSemeter,
            defaultDate: selSemeter.startTime,
            selDate: selSemeter.startTime,
            selTime: selSemeter.startTime
        })
        this.props.editTime({ timeType: "", selTime: selSemeter.startTime });
    }
    ...
    render() {
        ...
        return (
            <div className="ws-selTime report" id="selTime">
                    ...
                    <span>
                        <Popover onVisibleChange={this.onDateVisibleChange} visible={dateVisible} overlayClassName="ws-popover" placement="bottom" content={
                            <DatePicker
                                ...
                                dropdownClassName="ws-datePicker report"
                                format={'YYYY-MM-DD'}
                        ...
                        <Popover onVisibleChange={this.onMonthVisibleChange} visible={monthVisible} overlayClassName="ws-popover" placement="bottom" content={
                            <MonthPicker
                                className="ws-datePicker-sel"
                                dropdownClassName="ws-monthPicker report"
                                format={'YYYY-MM'}
