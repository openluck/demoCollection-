 ...
 * @Last Modified by: tj
 * @Last Modified time: 2020-07-30 13:19:57
 * 课程画像-基本信息
 */
...
class Jbxx extends Component {
  ...
  getBaseInfo (topParams) {
    request('/api/image/getCourseBaseInfo', topParams, (res) => {
      if (res.result) {
  ...
  render () {
    ...
    return (
      <div className="ws-scl_jbxx">
        <div className="ws-cour-jbxx-exhibition">
          <div>
            <div><SVG type="img_jxb" />教学班数量</div>
            <div>
          ...
          <div>
            ...
            <div>
              <div>
                <p>授课教师数</p>
                <p>
                  <span>{baseInfo.lecturerCount}</span>
                  <span>人</span>
                </p>
              </div>
              <div>
                <p>人均节次</p>
                <p>
                  <span>{baseInfo.perCapitaHour}</span>
                  <span>节</span>
                </p>
              </div>
            </div>
