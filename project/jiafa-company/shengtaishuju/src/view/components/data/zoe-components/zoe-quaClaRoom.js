 ...
 * @Last Modified by: tj
 * @Last Modified time: 2021-01-20 16:54:27
 * 教学秩序-课程统计-课堂统计页面
 */
...
class ZoeQuaClaRoom extends Component {
  constructor(props) {
    super(props);
    this.state = {
      collegeId: '', //开课单位id
  ...
  clickRow = (record) => {
    ...
    // 底层页跳转播放页
    this.props.history.push(`/home/data/quacour/${record.claRoomId}`)
  ...
  render() {
    const { collegeId, courseId, pinkInfo, pageNum, pageSize, QuaClaRoomSta, curSign, isLoading } = this.props
    const orderTh = [
      {
        title: "开课单位",
    ...
    return (
      <div style={{ height: "calc(100% - 45px)" }}>
        <ZoeQuaStatis subPageType={1} curSign={4} />
